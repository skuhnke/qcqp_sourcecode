...
$load COEFF_QUAD COEFF RHS BOUND_LO BOUND_UP
...
QCP_TIGHTEN_BOUNDS.holdfixed = 1;
QCP_TIGHTEN_BOUNDS.tolInfeas = FEAS_TOLERANCE;
QCP_TIGHTEN_BOUNDS.OptFile = 1;
